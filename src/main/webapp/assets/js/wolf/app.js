...
appMdl.config(function($stateProvider, $urlRouterProvider) {
	...
	$stateProvider.state('index', {
		...
		views : {
			'' : {
				templateUrl : 'assets/tpls/wolf/index.html'
			},
			'nav@index' : {
				templateUrl : 'assets/tpls/wolf/nav.html'
			},
			'banner@index' : {
				templateUrl : 'assets/tpls/wolf/banner.html'
			},
			'wolfbook@index' : {
				templateUrl : 'assets/tpls/wolf/wolfbook.html'
			},
			'loginregister@index' : {
				templateUrl : 'assets/tpls/wolf/common/loginregister.html'
			}
		}
	}).state('main', {

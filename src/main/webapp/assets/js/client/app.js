...
appMdl.config(function($stateProvider, $urlRouterProvider) {
	...
	$stateProvider.state('index', {
		...
		views : {
			'' : {
				templateUrl : 'assets/tpls/client/index.html'
			},
			'nav@index' : {
				templateUrl : 'assets/tpls/client/nav.html'
			},
			'banner@index' : {
				templateUrl : 'assets/tpls/client/banner.html'
			},
			'wolfbook@index' : {
				templateUrl : 'assets/tpls/client/wolfbook.html'
			},
			'loginregister@index' : {
				templateUrl : 'assets/tpls/client/common/loginregister.html'
			}
		}
	}).state('main', {
